...
function renderHome() {
  ...
  <body>
    ...
    <main id="main">
      <section class="hero">
        <div class="hero-copy">
          <p class="eyebrow">Plain-English AI literacy</p>
          <h1>The AI Explainer</h1>
          <p>A practical guide library for readers who want to understand AI tools, use them carefully, protect private information, and keep human judgment in the loop.</p>
          <div class="hero-links">
            <a href="articles.html">Browse all guides</a>
            <a href="articles/ai-privacy-checklist-before-you-paste.html">Start with privacy</a>
          </div>
        </div>
        <dl class="hero-facts" aria-label="Site summary">
          <div><dt>${articles.length}</dt><dd>plain-English guides</dd></div>
          <div><dt>${toolPages.length}</dt><dd>browser-based tools</dd></div>
          <div><dt>Reviewed</dt><dd>clear limits, sources, and practical checks</dd></div>
        </dl>
      </section>
